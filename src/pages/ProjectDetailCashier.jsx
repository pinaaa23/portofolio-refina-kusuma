...
export default function ProjectDetailCashier() {
  ...
  return (
    <main className="relative min-h-screen bg-[#0a0512] text-white">
      {/* ── BG Layer ── */}
      <div className="pointer-events-none fixed inset-0 bg-[radial-gradient(circle_at_10%_20%,rgba(139,92,246,0.25),transparent_28%),radial-gradient(circle_at_90%_20%,rgba(168,85,247,0.18),transparent_26%),radial-gradient(circle_at_20%_90%,rgba(217,70,239,0.2),transparent_30%),linear-gradient(135deg,#0a0512_0%,#100318_45%,#05020b_100%)]" />
