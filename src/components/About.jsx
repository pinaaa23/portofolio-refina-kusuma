  ...
  return (
    <section id="about" className="scrapbook-bg min-h-screen lg:h-screen py-10 lg:py-0 px-6 md:px-16 flex flex-col items-center justify-center overflow-hidden relative">
      ...
      >
        ...
        {/* ─── CENTER-RIGHT ZONE: POLAROIDS (z-20) ─── */}
        <div className="hidden lg:block">
          ...
          <motion.div 
            ...
            className="absolute top-[200px] left-[42%] z-20 cursor-pointer"
          >
        ...
        <div className="flex flex-col gap-10 lg:block lg:w-1/2 h-full lg:absolute lg:top-0 lg:right-0 z-30 pointer-events-none">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="lg:absolute lg:top-25 lg:right-4 mb-10 lg:mb-0 pointer-events-auto"
          >
          ...
          <motion.div 
            ...
            transition={{ duration: 0.8, ease: cubicBezier, delay: 0.6 }}
            viewport={{ once: true }}
            className="lg:absolute lg:top-[420px] lg:right-12 z-30 pointer-events-auto"
          >
